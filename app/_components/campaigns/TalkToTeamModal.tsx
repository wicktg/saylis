    ...
    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center bg-[rgba(20,18,34,0.28)]">
      <div className="mobile-sheet pixel-frame pixel-panel relative w-full max-w-sm mx-4 p-5">
        ...
        <div className="flex flex-col items-center text-center gap-3 py-2">
          <div className="w-12 h-12 rounded-full bg-[var(--surface-sunken)] border border-[var(--line)] flex items-center justify-center">
            <Icon icon="mdi:telegram" className="text-xl text-[#2ea6de]" />
          </div>
          <h2 className="text-base font-bold">Talk to the Team</h2>
          <p className="text-[11px] text-[var(--ink-soft)] leading-relaxed max-w-[16rem]">
          ...
          <p className="text-[10px] text-[var(--ink-faint)] leading-snug mt-1">
