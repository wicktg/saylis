    ...
    <>
      {!open && (
        <button
          ...
          className="fixed left-5 z-40 grid place-items-center w-12 h-12 rounded-[var(--r-lg)] border-[0.5px] border-[rgba(31,31,36,0.5)] bg-[var(--surface)] text-[var(--brand)] focus:outline-none focus-visible:outline-none"
